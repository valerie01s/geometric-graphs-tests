...
:assumption (= mw (+ (* (- e_3 e_6) (- e_3 e_6)) (* (- e_7 e_10) (- e_7 e_10))))
:assumption (= vm (+ (* (- e_5 e_3) (- e_5 e_3)) (* (- e_9 e_7) (- e_9 e_7))))
:assumption (= vw (+ (* (- e_5 e_6) (- e_5 e_6)) (* (- e_9 e_10) (- e_9 e_10))))
:assumption (= um (+ (* (- e_4 e_3) (- e_4 e_3)) (* (- e_8 e_7) (- e_8 e_7))))
:assumption (= uw (+ (* (- e_4 e_6) (- e_4 e_6)) (* (- e_8 e_10) (- e_8 e_10))))
:assumption (= uv (+ (* (- e_4 e_5) (- e_4 e_5)) (* (- e_8 e_9) (- e_8 e_9))))
:assumption (or (= e_1 0) (<= mw um))
:assumption (or (= e_1 0) (= e_2 1))
:assumption (or (= e_1 1) (= e_2 0) (> mw um))
:assumption (or (= e_2 1) (= e_1 1))
:assumption (or (< vw uv) (= e_1 1))
:assumption (or (< uw uv) (= e_1 1))
:assumption (or (= e_1 0) (= e_2 0) (>= uw uv) (>= vw uv))
:assumption (not (= v m))
:assumption (not (= w m))
:assumption (not (= v w))
:assumption (not (= u m))
