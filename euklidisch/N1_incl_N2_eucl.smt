...
:assumption (not (= v w))
:assumption (not (= u v))
:assumption (or (= e_25 0) (= e_27 1))
:assumption (or (= e_27 0) (= e_25 1))
:assumption (or (= e_26 0) (= e_23 1))
:assumption (or (= e_23 0) (= e_26 1))
:assumption (or (= e_24 0) (= e_22 1))
:assumption (or (= e_22 0) (= e_24 1))
:assumption (or (= e_27 0) (< uv vw) (< uw vw))
:assumption (or (= e_27 0) (= e_28 1))
:assumption (or (= e_27 1) (= e_28 0) (>= uw vw))
:assumption (or (= e_27 1) (= e_28 0) (>= uv vw))
:assumption (or (= e_25 0) (< uv vw) (< uw vw))
:assumption (or (= e_25 0) (= e_28 1))
:assumption (or (= e_25 1) (= e_28 0) (>= vw vw))
:assumption (or (= e_25 1) (= e_28 0) (>= uv vw))
:assumption (or (= e_26 0) (< uv uw) (< vw uw))
:assumption (or (= e_26 0) (= e_29 1))
:assumption (or (= e_26 1) (= e_29 0) (>= vw uw))
:assumption (or (= e_26 1) (= e_29 0) (>= uv uw))
:assumption (or (= e_23 0) (< uv uw) (< vw uw))
:assumption (or (= e_23 0) (= e_29 1))
:assumption (or (= e_23 1) (= e_29 0) (>= vw uw))
:assumption (or (= e_23 1) (= e_29 0) (>= uv uw))
:assumption (or (= e_24 0) (< uw uv) (< vw uv))
:assumption (or (= e_24 0) (= e_30 1))
:assumption (or (= e_24 1) (= e_30 0) (>= vw uv))
:assumption (or (= e_24 1) (= e_30 0) (>= uw uv))
:assumption (or (= e_22 0) (< uw uv) (< vw uv))
:assumption (or (= e_22 0) (= e_30 1))
:assumption (or (= e_22 1) (= e_30 0) (>= vw uv))
:assumption (or (= e_22 1) (= e_30 0) (>= uw uv))
:assumption (or (< uv vw) (= e_25 1))
:assumption (or (= e_28 1) (= e_25 1))
:assumption (or (< uw vw) (= e_27 1))
:assumption (or (= e_28 1) (= e_27 1))
:assumption (or (< vw uw) (= e_26 1))
:assumption (or (= e_29 1) (= e_26 1))
:assumption (or (< uv uw) (= e_23 1))
:assumption (or (= e_29 1) (= e_23 1))
:assumption (or (< vw uv) (= e_24 1))
:assumption (or (= e_30 1) (= e_24 1))
:assumption (or (< uw uv) (= e_22 1))
:assumption (or (= e_30 1) (= e_22 1))
