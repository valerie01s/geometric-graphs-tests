...
:assumption (= e_30 1)
:assumption (= e_29 1)
:assumption (or (= e_30 1) (= e_29 1))
:assumption (or (< vw uv) (= e_29 1))
:assumption (or (< uw uv) (= e_29 1))
:assumption (or (= e_29 0) (= e_30 0) (>= uw uv) (>= vw uv))
:assumption (not (= v m))
:assumption (not (= w m))
:assumption (not (= v w))
:assumption (not (= u m))
...
:assumption (implies (and (= xmu xvw) (= ymu yvw)) (= e_39 e_43))
:assumption (implies (and (= xmu xuw) (= ymu yuw)) (= e_39 e_42))
:assumption (implies (and (= xmu xuv) (= ymu yuv)) (= e_39 e_41))
:assumption (implies (and (= xmu xmw) (= ymu ymw)) (= e_39 e_40))
:assumption (implies (and (= xmw xvw) (= ymw yvw)) (= e_40 e_43))
:assumption (implies (and (= xmw xuw) (= ymw yuw)) (= e_40 e_42))
:assumption (implies (and (= xmw xuv) (= ymw yuv)) (= e_40 e_41))
:assumption (implies (and (= xuv xvw) (= yuv yvw)) (= e_41 e_43))
:assumption (implies (and (= xuv xuw) (= yuv yuw)) (= e_41 e_42))
:assumption (implies (and (= xuw xvw) (= yuw yvw)) (= e_42 e_43))
:assumption (implies (and (= xmu yvw) (= d_26 d_18)) (= e_44 e_53))
:assumption (implies (and (= xmu yuw) (= d_26 d_14)) (= e_44 e_52))
:assumption (implies (and (= xmu yuv) (= d_26 d_8)) (= e_44 e_51))
:assumption (implies (and (= xmu ymw) (= d_26 d_24)) (= e_44 e_50))
:assumption (implies (and (= xmu ymu) (= d_26 d_28)) (= e_44 e_49))
:assumption (implies (and (= xmu xvw) (= d_26 d_16)) (= e_44 e_48))
:assumption (implies (and (= xmu xuw) (= d_26 d_11)) (= e_44 e_47))
:assumption (implies (and (= xmu xuv) (= d_26 d_4)) (= e_44 e_46))
:assumption (implies (and (= xmu xmw) (= d_26 d_21)) (= e_44 e_45))
:assumption (implies (and (= xmw yvw) (= d_21 d_18)) (= e_45 e_53))
:assumption (implies (and (= xmw yuw) (= d_21 d_14)) (= e_45 e_52))
:assumption (implies (and (= xmw yuv) (= d_21 d_8)) (= e_45 e_51))
:assumption (implies (and (= xmw ymw) (= d_21 d_24)) (= e_45 e_50))
:assumption (implies (and (= xmw ymu) (= d_21 d_28)) (= e_45 e_49))
:assumption (implies (and (= xmw xvw) (= d_21 d_16)) (= e_45 e_48))
:assumption (implies (and (= xmw xuw) (= d_21 d_11)) (= e_45 e_47))
:assumption (implies (and (= xmw xuv) (= d_21 d_4)) (= e_45 e_46))
:assumption (implies (and (= xuv yvw) (= d_4 d_18)) (= e_46 e_53))
:assumption (implies (and (= xuv yuw) (= d_4 d_14)) (= e_46 e_52))
:assumption (implies (and (= xuv yuv) (= d_4 d_8)) (= e_46 e_51))
:assumption (implies (and (= xuv ymw) (= d_4 d_24)) (= e_46 e_50))
:assumption (implies (and (= xuv ymu) (= d_4 d_28)) (= e_46 e_49))
:assumption (implies (and (= xuv xvw) (= d_4 d_16)) (= e_46 e_48))
:assumption (implies (and (= xuv xuw) (= d_4 d_11)) (= e_46 e_47))
:assumption (implies (and (= xuw yvw) (= d_11 d_18)) (= e_47 e_53))
:assumption (implies (and (= xuw yuw) (= d_11 d_14)) (= e_47 e_52))
:assumption (implies (and (= xuw yuv) (= d_11 d_8)) (= e_47 e_51))
:assumption (implies (and (= xuw ymw) (= d_11 d_24)) (= e_47 e_50))
:assumption (implies (and (= xuw ymu) (= d_11 d_28)) (= e_47 e_49))
:assumption (implies (and (= xuw xvw) (= d_11 d_16)) (= e_47 e_48))
:assumption (implies (and (= xvw yvw) (= d_16 d_18)) (= e_48 e_53))
:assumption (implies (and (= xvw yuw) (= d_16 d_14)) (= e_48 e_52))
:assumption (implies (and (= xvw yuv) (= d_16 d_8)) (= e_48 e_51))
:assumption (implies (and (= xvw ymw) (= d_16 d_24)) (= e_48 e_50))
:assumption (implies (and (= xvw ymu) (= d_16 d_28)) (= e_48 e_49))
:assumption (implies (and (= ymu yvw) (= d_28 d_18)) (= e_49 e_53))
:assumption (implies (and (= ymu yuw) (= d_28 d_14)) (= e_49 e_52))
:assumption (implies (and (= ymu yuv) (= d_28 d_8)) (= e_49 e_51))
:assumption (implies (and (= ymu ymw) (= d_28 d_24)) (= e_49 e_50))
:assumption (implies (and (= ymw yvw) (= d_24 d_18)) (= e_50 e_53))
:assumption (implies (and (= ymw yuw) (= d_24 d_14)) (= e_50 e_52))
:assumption (implies (and (= ymw yuv) (= d_24 d_8)) (= e_50 e_51))
:assumption (implies (and (= yuv yvw) (= d_8 d_18)) (= e_51 e_53))
:assumption (implies (and (= yuv yuw) (= d_8 d_14)) (= e_51 e_52))
:assumption (implies (and (= yuw yvw) (= d_14 d_18)) (= e_52 e_53))
...
:assumption (implies (= e_44 1) (= (* xmu xmu) d_26))
:assumption (implies (= e_45 1) (= (* xmw xmw) d_21))
:assumption (implies (= e_46 1) (= (* xuv xuv) d_4))
:assumption (implies (= e_47 1) (= (* xuw xuw) d_11))
:assumption (implies (= e_48 1) (= (* xvw xvw) d_16))
:assumption (implies (= e_49 1) (= (* ymu ymu) d_28))
:assumption (implies (= e_50 1) (= (* ymw ymw) d_24))
:assumption (implies (= e_51 1) (= (* yuv yuv) d_8))
:assumption (implies (= e_52 1) (= (* yuw yuw) d_14))
:assumption (implies (= e_53 1) (= (* yvw yvw) d_18))
:assumption (implies (and (= (* xmu xmu) d_26) (>= xmu 0)) (= e_44 1))
:assumption (implies (and (= (* xmw xmw) d_21) (>= xmw 0)) (= e_45 1))
:assumption (implies (and (= (* xuv xuv) d_4) (>= xuv 0)) (= e_46 1))
:assumption (implies (and (= (* xuw xuw) d_11) (>= xuw 0)) (= e_47 1))
:assumption (implies (and (= (* xvw xvw) d_16) (>= xvw 0)) (= e_48 1))
:assumption (implies (and (= (* ymu ymu) d_28) (>= ymu 0)) (= e_49 1))
:assumption (implies (and (= (* ymw ymw) d_24) (>= ymw 0)) (= e_50 1))
:assumption (implies (and (= (* yuv yuv) d_8) (>= yuv 0)) (= e_51 1))
:assumption (implies (and (= (* yuw yuw) d_14) (>= yuw 0)) (= e_52 1))
:assumption (implies (and (= (* yvw yvw) d_18) (>= yvw 0)) (= e_53 1))
:assumption (implies (= e_44 1) (>= xmu 0))
:assumption (implies (= e_45 1) (>= xmw 0))
:assumption (implies (= e_46 1) (>= xuv 0))
:assumption (implies (= e_47 1) (>= xuw 0))
:assumption (implies (= e_48 1) (>= xvw 0))
:assumption (implies (= e_49 1) (>= ymu 0))
:assumption (implies (= e_50 1) (>= ymw 0))
:assumption (implies (= e_51 1) (>= yuv 0))
:assumption (implies (= e_52 1) (>= yuw 0))
:assumption (implies (= e_53 1) (>= yvw 0))
:assumption (implies (< xmu 0) (= e_44 0))
:assumption (implies (< xmw 0) (= e_45 0))
:assumption (implies (< xuv 0) (= e_46 0))
:assumption (implies (< xuw 0) (= e_47 0))
:assumption (implies (< xvw 0) (= e_48 0))
:assumption (implies (< ymu 0) (= e_49 0))
:assumption (implies (< ymw 0) (= e_50 0))
:assumption (implies (< yuv 0) (= e_51 0))
:assumption (implies (< yuw 0) (= e_52 0))
:assumption (implies (< yvw 0) (= e_53 0))
...
:assumption (implies (>= xmu ymu) (= e_39 xmu))
:assumption (implies (>= xmw ymw) (= e_40 xmw))
:assumption (implies (>= xuv yuv) (= e_41 xuv))
:assumption (implies (>= xuw yuw) (= e_42 xuw))
:assumption (implies (>= xvw yvw) (= e_43 xvw))
:assumption (implies (< xmu ymu) (= e_39 ymu))
:assumption (implies (< xmw ymw) (= e_40 ymw))
:assumption (implies (< xuv yuv) (= e_41 yuv))
:assumption (implies (< xuw yuw) (= e_42 yuw))
:assumption (implies (< xvw yvw) (= e_43 yvw))
:assumption (implies (= e_39 xmu) (>= xmu ymu))
:assumption (implies (= e_40 xmw) (>= xmw ymw))
:assumption (implies (= e_41 xuv) (>= xuv yuv))
:assumption (implies (= e_42 xuw) (>= xuw yuw))
:assumption (implies (= e_43 xvw) (>= xvw yvw))
:assumption (implies (= e_39 ymu) (< xmu ymu))
:assumption (implies (= e_40 ymw) (< xmw ymw))
:assumption (implies (= e_41 yuv) (< xuv yuv))
:assumption (implies (= e_42 yuw) (< xuw yuw))
:assumption (implies (= e_43 yvw) (< xvw yvw))
:assumption (or (= e_39 xmu) (= e_39 ymu))
:assumption (or (= e_40 xmw) (= e_40 ymw))
:assumption (or (= e_41 xuv) (= e_41 yuv))
:assumption (or (= e_42 xuw) (= e_42 yuw))
:assumption (or (= e_43 xvw) (= e_43 yvw))
:assumption (implies (= m u) (= e_31 e_32))
:assumption (implies (= m v) (= e_31 e_33))
:assumption (implies (= m w) (= e_31 e_34))
