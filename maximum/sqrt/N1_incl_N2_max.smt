...
:assumption (implies (and (= xuv xvw) (= yuv yvw)) (= e_28 e_30))
:assumption (implies (and (= xuv xuw) (= yuv yuw)) (= e_28 e_29))
:assumption (implies (and (= xuw xvw) (= yuw yvw)) (= e_29 e_30))
:assumption (implies (and (= xuv yvw) (= d_4 d_18)) (= e_31 e_36))
:assumption (implies (and (= xuv yuw) (= d_4 d_14)) (= e_31 e_35))
:assumption (implies (and (= xuv yuv) (= d_4 d_8)) (= e_31 e_34))
:assumption (implies (and (= xuv xvw) (= d_4 d_16)) (= e_31 e_33))
:assumption (implies (and (= xuv xuw) (= d_4 d_11)) (= e_31 e_32))
:assumption (implies (and (= xuw yvw) (= d_11 d_18)) (= e_32 e_36))
:assumption (implies (and (= xuw yuw) (= d_11 d_14)) (= e_32 e_35))
:assumption (implies (and (= xuw yuv) (= d_11 d_8)) (= e_32 e_34))
:assumption (implies (and (= xuw xvw) (= d_11 d_16)) (= e_32 e_33))
:assumption (implies (and (= xvw yvw) (= d_16 d_18)) (= e_33 e_36))
:assumption (implies (and (= xvw yuw) (= d_16 d_14)) (= e_33 e_35))
:assumption (implies (and (= xvw yuv) (= d_16 d_8)) (= e_33 e_34))
:assumption (implies (and (= yuv yvw) (= d_8 d_18)) (= e_34 e_36))
:assumption (implies (and (= yuv yuw) (= d_8 d_14)) (= e_34 e_35))
:assumption (implies (and (= yuw yvw) (= d_14 d_18)) (= e_35 e_36))
...
:assumption (implies (= e_31 1) (= (* xuv xuv) d_4))
:assumption (implies (= e_32 1) (= (* xuw xuw) d_11))
:assumption (implies (= e_33 1) (= (* xvw xvw) d_16))
:assumption (implies (= e_34 1) (= (* yuv yuv) d_8))
:assumption (implies (= e_35 1) (= (* yuw yuw) d_14))
:assumption (implies (= e_36 1) (= (* yvw yvw) d_18))
:assumption (implies (and (= (* xuv xuv) d_4) (>= xuv 0)) (= e_31 1))
:assumption (implies (and (= (* xuw xuw) d_11) (>= xuw 0)) (= e_32 1))
:assumption (implies (and (= (* xvw xvw) d_16) (>= xvw 0)) (= e_33 1))
:assumption (implies (and (= (* yuv yuv) d_8) (>= yuv 0)) (= e_34 1))
:assumption (implies (and (= (* yuw yuw) d_14) (>= yuw 0)) (= e_35 1))
:assumption (implies (and (= (* yvw yvw) d_18) (>= yvw 0)) (= e_36 1))
:assumption (implies (= e_31 1) (>= xuv 0))
:assumption (implies (= e_32 1) (>= xuw 0))
:assumption (implies (= e_33 1) (>= xvw 0))
:assumption (implies (= e_34 1) (>= yuv 0))
:assumption (implies (= e_35 1) (>= yuw 0))
:assumption (implies (= e_36 1) (>= yvw 0))
:assumption (implies (< xuv 0) (= e_31 0))
:assumption (implies (< xuw 0) (= e_32 0))
:assumption (implies (< xvw 0) (= e_33 0))
:assumption (implies (< yuv 0) (= e_34 0))
:assumption (implies (< yuw 0) (= e_35 0))
:assumption (implies (< yvw 0) (= e_36 0))
...
:assumption (implies (>= xuv yuv) (= e_28 xuv))
:assumption (implies (>= xuw yuw) (= e_29 xuw))
:assumption (implies (>= xvw yvw) (= e_30 xvw))
:assumption (implies (< xuv yuv) (= e_28 yuv))
:assumption (implies (< xuw yuw) (= e_29 yuw))
:assumption (implies (< xvw yvw) (= e_30 yvw))
:assumption (implies (= e_28 xuv) (>= xuv yuv))
:assumption (implies (= e_29 xuw) (>= xuw yuw))
:assumption (implies (= e_30 xvw) (>= xvw yvw))
:assumption (implies (= e_28 yuv) (< xuv yuv))
:assumption (implies (= e_29 yuw) (< xuw yuw))
:assumption (implies (= e_30 yvw) (< xvw yvw))
:assumption (or (= e_28 xuv) (= e_28 yuv))
:assumption (or (= e_29 xuw) (= e_29 yuw))
:assumption (or (= e_30 xvw) (= e_30 yvw))
:assumption (implies (= u v) (= e_22 e_23))
:assumption (implies (= u w) (= e_22 e_24))
