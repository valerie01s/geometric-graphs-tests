...
1) Liegt G-> in P?
--------------------------------------------
input H-PILoT: G-r_incl_P_max.loc
...
2) Liegt G in R? 
--------------------------------------------
input H-PILoT: G_incl_R_max.loc
Z3 sat nach 0,16 s
timeout REDLOG nach 5 min
Verwendung amnt
Modell beschreibt Situation in der sowohl die Kante uv als auch der Knoten w existieren,
Pi_G(u,v) ist erfüllt da w außerhalb des Quadrats um m dessen Kantenlänge uv ist liegt, 
Pi_R(u,v) ist jedoch nicht erfüllt, da w im Durchschnitt der Quadrate um u und v, deren 
halbe Kantenlänge die Kantenlänge uv ist, liegt.  

--------------------------------------------
3) Liegt G-> in R->? 
--------------------------------------------
input H-PILoT: G-r_incl_R-r_max.loc
timeout Z3 nach 5 min
REDLOG true nach 0,65 s
Verwendung sqrt
...
---
input H-PILoT: G-r_incl_R-r_max2.loc
Z3 sat nach 0,15 s
REDLOG unknown nach 4,9 min
Verwendung amnt

--------------------------------------------
4) Liegt R in G? 
--------------------------------------------
input H-PILoT: R_incl_G_max.loc
Z3 sat nach 0,14 s
timeout REDLOG nach 5 min
Verwendung amnt
...
5) Liegt R-> in G->? 
--------------------------------------------
input H-PILoT: R-r_incl_G-r_max.loc
Z3 sat nach 0,14 s
timeout REDLOG nach 5 min
Verwendung amnt
...
6) Liegt R in G->? 
--------------------------------------------
input H-PILoT: R_incl_G-r_max.loc
timeout Z3 nach 10 min
REDLOG false nach 7,47 s
Verwendung sqrt
Inklusion gilt.
---
input H-PILoT: R_incl_G-r_max.loc
Z3 unsat nach 0,15 s
REDLOG false nach 4 min
Verwendung amnt

--------------------------------------------
7) Liegt N2 in R? 
--------------------------------------------
input H-PILoT: N2_incl_R_max.loc
Z3 sat nach 0,04 s
REDLOG true nach 0,17 s
Verwendung amnt
Modell beschreibt eine Situation in der die Kante uv nicht existiert, es einen Knoten w gibt 
...
8) Liegt N2-> in R->? 
--------------------------------------------
input H-PILoT: N2-r_incl_R-r_max.loc
...
9) Liegt N2-> in R? 
--------------------------------------------
input H-PILoT: N2-r_incl_R_max.loc
Z3 sat nach 0,04 s
REDLOG true nach 0,16 s
Verwendung amnt
...
10) Liegt N2 in R->? 
--------------------------------------------
input H-PILoT: N2_incl_R-r_max.loc
...
11) Liegt N2 in R<-? 
--------------------------------------------
input H-PILoT: N2_incl_R-l_max.loc
Z3 sat nach 0,04 s
REDLOG true nach 0,17 s
Verwendung amnt
...
12) Liegt N2<- in R<-? 
--------------------------------------------
input H-PILoT: N2-l_incl_R-l_max.loc
Z3 sat nach 0,04 s
REDLOG true nach 0,16 s
Verwendung amnt
...
13) Liegt N1 in R->? 
--------------------------------------------
input H-PILoT: N1_incl_R-r_max.loc
Z3 unsat nach 0,05 s
REDLOG false nach 0,08 s
Verwendung amnt
...
14) Liegt N1-> in R->? 
--------------------------------------------
input H-PILoT: N1-r_incl_R-r_max.loc
Z3 unsat nach 0,05 s
REDLOG false nach 0,08 s
Verwendung amnt
Inklusion gilt (N1 symmetrisiert).
...
15) Liegt R-> in N1->? 
--------------------------------------------
input H-PILoT: R-r_incl_N1-r_max.loc
Z3 sat nach 0,05 s
REDLOG true nach 0,17 s
Verwendung amnt
...
16) Liegt N1 in N2? 
--------------------------------------------
input H-PILoT: N1_incl_N2_max.loc
Z3 unsat nach 0,05 s
REDLOG false nach 0,60 s
Verwendung sqrt
Inklusion gilt (N1 symmetrisiert).
...
18) Liegt N2 in N1? 
--------------------------------------------
input H-PILoT: N2_incl_N1_max.loc
Z3 sat nach 0,04 s
...
19) Liegt N2 in N1->? 
--------------------------------------------
input H-PILoT: N2_incl_N1-r_max.loc
Z3 unsat nach 0,05 s
REDLOG false nach 0,09 s
Verwendung sqrt
Inklusion gilt.
---
input H-PILoT: N2_incl_N1-r_max2.loc
Z3 unsat nach 0,05 s
REDLOG false nach 0,08 s
Verwendung amnt
